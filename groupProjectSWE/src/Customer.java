    ...
    private Customer(){
        ...
        dietPepsiButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int comboSelected = comboBox1.getSelectedIndex();
                if (comboSelected != 0) {
                    list2.addElement(size + " Diet Pepsi " + "$" + price);
                    list1.setModel(list2);
                    total += price;
                    Total.setText("Total: " + total);
                    System.out.println();
        ...
        crushButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int comboSelected = comboBox1.getSelectedIndex();
                if (comboSelected != 0) {
                    list2.addElement(size + " Crush " + "$" + price);
                    list1.setModel(list2);
                    total+=price;
                    Total.setText("Total: " + total);
                    System.out.println();
        ...
        dietCrushButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int comboSelected = comboBox1.getSelectedIndex();
                if (comboSelected != 0) {
                    list2.addElement(size + " Diet Crush " + "$" + price);
                    list1.setModel(list2);
                    total+=price;
                    Total.setText("Total: " + total);
                    System.out.println();
        ...
        mugButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int comboSelected = comboBox1.getSelectedIndex();
                if (comboSelected != 0) {
                    list2.addElement(size + " Mug " + "$" + price);
                    list1.setModel(list2);
                    total+=price;
                    Total.setText("Total: " + total);
                    System.out.println();
        ...
        dietMugButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int comboSelected = comboBox1.getSelectedIndex();
                if (comboSelected != 0) {
                    list2.addElement(size + " Diet Mug " + "$" + price);
                    list1.setModel(list2);
                    total+=price;
                    Total.setText("Total: " + total);
                    System.out.println();
        ...
        starryButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int comboSelected = comboBox1.getSelectedIndex();
                if (comboSelected != 0) {
                    list2.addElement(size + " Starry " + "$" + price);
                    list1.setModel(list2);
                    total+=price;
                    Total.setText("Total: " + total);
                    System.out.println();
        ...
        tropicanaLemonadeButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int comboSelected = comboBox1.getSelectedIndex();
                if (comboSelected != 0) {
                    list2.addElement(size + " Tropicana Lemonade " + "$" + price);
                    list1.setModel(list2);
                    total+=price;
                    Total.setText("Total: " + total);
                    System.out.println();
